        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-offset-4 col-md-4 ">
                    <hr>
                    <form action="<%=request.getContextPath()%>/authenticate" id="loginform" method="post" class="form-horizontal" novalidate="">
                        ...
                        <div class="form-group">
                            ...
                            <button class="btn btn-info btn-block btn-lg" type="button" name="_eventId_proceed" onclick="location.href='<%=request.getContextPath()%>/Signup.jsp';">Signup</button>
                        </div>
                    </form>
                    <hr>
                </div>
